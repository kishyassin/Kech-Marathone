...
if (date("Y-m-d") >= $dateLists){
    require_once('./php/connection.php');
    $query = "SELECT * FROM athletes WHERE chrono IS NOT NULL ";
    ...
    <header class="container-fluid position-fixed top-0 bg-light shadow-lg">
        <div class="row">
            ...
            <div class="col-7 row">
                ...
                <div class="col align-content-center justify-content-center d-flex p-3">
                    <a href="./result.php" class="btn text-center fw-bold text-danger">Result</a>
                </div>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row p-3 bg-light mt-5">
            <div class="col-12 bg-light mt-5">
                <span class=" fw-bold fs-3 text text-center w-100">Marathone's Results Not Done yet ! </span>
                <span class=" fw-bold text-center  w-100">Please Come Back on <?= $dateLists ?></span>
            </div>
        </div>
    </div>
